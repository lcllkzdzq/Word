...
extension SignUpRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SignUpRequest"
  ...
  func _protobuf_generated_isEqualTo(other: SignUpRequest) -> Bool {
...
extension SignUpResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SignUpResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "header"),
  ...
  func _protobuf_generated_isEqualTo(other: SignUpResponse) -> Bool {
